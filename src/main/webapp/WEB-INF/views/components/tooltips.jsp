...
<%--    <!-- Google Fonts -->--%>
<%--    <link href="${contextPath}/static/fonts/img/favicon.png">--%>
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="${contextPath}/dashboard">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Memebers</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
...
<%--        </li><!-- End Icons Nav -->--%>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="${contextPath}/faq">
                <i class="bi bi-question-circle"></i>
                <span>F.A.Q</span>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="${contextPath}/contact">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="${contextPath}/login/regist">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="${contextPath}/login">
